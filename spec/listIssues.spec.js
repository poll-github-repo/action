...
it('returns all issues with given label by default', async () => {
    ...
    expect(this.core.messages).toEqual([
        ...
        `debug: Extracted issue {"number":2,"url":"https://github.com/poll-github-repo/dummy-repo/issues/2","labels":["test-label","other-label"],"state":"open","createdAt":"2022-03-14T18:33:52Z"}`,
        `debug: Extracted issue {"number":1,"url":"https://github.com/poll-github-repo/dummy-repo/issues/1","labels":["test-label"],"state":"open","createdAt":"2022-03-14T18:33:22Z"}`,
        `endGroup`,
    ])
})
